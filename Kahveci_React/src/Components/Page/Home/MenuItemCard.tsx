...
function MenuItemCard(props: Props) {
  ...
  const handleAddToCart = async (menuItemId: number) => {
    ...
    if (response.data && response.data.isSuccess) {
      toastNotify("Ürün sepetinize eklendi!");
    }
        ...
        <div className="card-body pt-2">
          ...
          {props.menuItem.specialTag &&
            props.menuItem.specialTag.length > 0 && (
              <i
                className="bi bi-postage btn btn-outline-secondary"
                style={{
                  position: "absolute",
                  top: "15px",
                  left: "15px",
          ...
          {isAddingToCart ? (
            ...
            <i
              className="bi bi-basket btn btn-primary btn-outline-white"
              style={{
                position: "absolute",
                top: "15px",
                right: "15px",
