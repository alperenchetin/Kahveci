...
function CartSummary() {
  ...
  return (
    <div className="container p-4 m-2">
      <h4 className="text-center text-success">Sepet Özeti</h4>
        ...
        >
          ...
          <div className="p-2 mx-3" style={{ width: "100%" }}>
            <div className="d-flex justify-content-between align-items-center">
              ...
              <h4>
                {(cartItem.quantity! * cartItem.menuItem!.price).toFixed(2)} TL
              </h4>
            </div>
            <div className="flex-fill">
              <h4 className="text-danger">{cartItem.menuItem!.price} TL</h4>
            </div>
